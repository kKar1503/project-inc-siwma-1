  ...
  <div>
    <div className="bg-slate-50 items-center">
      {blueMessages.map((msg) => (
        <div className="flex justify-end mx-5" key={msg}>
      ...
      {greyMessages.map((msg) => (
        <div className="flex justify-start mx-5" key={msg}>
          <div className="bg-slate-300 rounded-tl-3xl rounded-tr-3xl rounded-br-3xl w-auto my-3">
