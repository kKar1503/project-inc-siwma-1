...
const BaseTableHeader = ({ showCheckbox, headingColor, headings, centerColumns, showActionsColumn }) => (
  <tr>
    {showCheckbox && (
      <th className={cx('top-0 sticky rounded-none z-20', headingColor)}> </th>
    )}
