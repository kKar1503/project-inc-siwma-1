 ...
 * @returns A table row
 */
const BaseTableRow = React.forwardRef(({ data, showCheckbox, columnKeys, headings, centerColumns, selected, actionMenu, onChange }, tableRef) => {
  // States
  ...
  useEffect(() => {
    ...
    if (actionMenuCoords.top < tableCoords.top || actionMenuCoords.right > tableCoords.right || actionMenuCoords.bottom > tableCoords.bottom || actionMenuCoords.left < tableCoords.left) {
        ...
        actionMenu && (
          <td>
            ...
            <div className='relative'>
              <div className={cx('absolute right-10 top-0 h-fit', { 'invisible': !showActionMenu })} ref={actionMenuRef}>
                {actionMenu}
              </div>
            </div>
          </td>
